...
// Uncomment to run this stage
        stage('Test DEV Application'){
            steps{
                httpRequest consoleLogResponseBody: true, ignoreSslErrors: true, responseHandle: 'NONE', url: 'http://${env.DEV_EKS_HOST}:30001', validResponseCodes: '200', wrapAsMultipart: false
            }
        }
